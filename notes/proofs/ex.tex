...
We define the actions of the state model as $\actions=\{\load, \store\}$, and the predicates $\Delta=\{\exP\}$. We define predicate satisfiability and symbolic interpretation as:
