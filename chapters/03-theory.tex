...
\begin{figure}
	...
	\delta &\in \Delta \\
	P, Q, ... \in \Asrt &\defeq \sym v \mid \vtrue \mid P \Rarr Q \mid P \lor Q \mid \exists \sym x \ldotp P \mid\\
	&\quad~ P * Q \mid \corepred{\delta}{\sins}{\souts}
	\end{align*}
