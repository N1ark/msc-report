...
\todobox{Little boxed out thing that presents the element of a state model. Just elements ($\St$, $\preds$, $\actions$) and functions (\execac, \consume, \produce, \fix), maybe descriptions, no signatures as they change later}
