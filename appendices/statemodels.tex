\chapter{State Model Definitions}
...
\begin{mathparpagebreakable}
\inferrule[CFracLoadOk]{}{\ppexec{\load}{\fracc{x,q},[]}{\Ok,\fracc{x,q},[x],[]}}
\and\inferrule[CFracLoadMiss]{}{\ppexec{\load}{\bot,[]}{\Miss,\bot,[1]}}
\and\inferrule[CFracStoreOk]{q=1}{\ppexec{\store}{\fracc{x,q},[x']}{\Ok,\fracc{x',q},[]}}
\and\inferrule[CFracStorePerm]{q<1}{\ppexec{\store}{\fracc{x,q},[x']}{\Miss,\fracc{x,q},[1-q]}}
\and\inferrule[CFracStoreMiss]{}{\ppexec{\store}{\bot,[x']}{\Miss,\bot,[1]}}
\end{mathparpagebreakable}
