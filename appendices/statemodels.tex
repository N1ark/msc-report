...
Similarly, we carry the symbolic rules for \execac, \consume, \produce{} and \fix{} by construction via the sum. The wrapped symbolic state model $\mmdl$ must provide an ${\code{is\_exclusively\_owned}\colon\Sst\rarr\LVal}$ function such that: \begin{align*}
